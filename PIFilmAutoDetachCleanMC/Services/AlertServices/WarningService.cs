...
namespace PIFilmAutoDetachCleanMC.Services
{
    public class WarningService : AlertServiceBase
    {
        ...
        {
            return Enum.GetValues(typeof(EWarning))
                       .Cast<EWarning>()
        ...
        {
            return ResolveAlertFolder(Path.Combine("Alert", "Warning"));
        }
    }
}
