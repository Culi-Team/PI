...
namespace PIFilmAutoDetachCleanMC.Recipe
{
    public class CSTLoadUnloadRecipe : RecipeBase
    {
        ...
        private double firstFixtureDistance;
        ...
        [SingleRecipeDescription(Description = "First Fixture Distance", Unit = Unit.mm)]
        public double FirstFixtureDistance
        {
            get { return firstFixtureDistance; }
            set
            {
                OnRecipeChanged(firstFixtureDistance, value);
                firstFixtureDistance = value;
                OnPropertyChanged(nameof(FirstFixtureDistance));
            }
        }
