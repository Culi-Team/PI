...
namespace PIFilmAutoDetachCleanMC.Defines
{
    public class Outputs
    {
        ...
        public IDOutput DetachClampCyl1Clamp => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_1_UNCLAMP);
        public IDOutput DetachClampCyl1Unclamp => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_1_CLAMP);
        public IDOutput DetachClampCyl2Clamp => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_2_UNCLAMP);
        public IDOutput DetachClampCyl2Unclamp => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_2_CLAMP);
        public IDOutput DetachClampCyl3Clamp => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_3_UNCLAMP);
        public IDOutput DetachClampCyl3Unclamp => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_3_CLAMP);
        public IDOutput DetachClampCyl4Clamp => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_4_UNCLAMP);
        public IDOutput DetachClampCyl4Unclamp => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_4_CLAMP);
