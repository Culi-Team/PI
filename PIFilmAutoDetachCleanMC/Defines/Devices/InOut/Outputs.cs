...
namespace PIFilmAutoDetachCleanMC.Defines
{
    public class Outputs
    {
        ...
        public IDOutput FixtureAlign1CylBw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.FIXTURE_ALIGN_1_CYL_BW);
        public IDOutput FixtureAlign1CylFw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.FIXTURE_ALIGN_1_CYL_FW);
        public IDOutput FixtureAlign2CylBw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.FIXTURE_ALIGN_2_CYL_BW);
        public IDOutput FixtureAlign2CylFw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.FIXTURE_ALIGN_2_CYL_FW);
        public IDOutput AlignFixtureIonRunStop => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_FIXTURE_ION_RUN_STOP);
        public IDOutput AlignFixtureIonMaintenanceDetect => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_FIXTURE_ION_MAINTENANCE_DETECT);
