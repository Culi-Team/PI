...
namespace PIFilmAutoDetachCleanMC.Defines
{
    public class Outputs
    {
        ...
        public IDOutput InCstFixCylBw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.IN_CST_FIX_CYL_BW);
        public IDOutput InCstFixCylFw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.IN_CST_FIX_CYL_FW);
        ...
        public IDOutput OutCstFixCylBw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.OUT_CST_FIX_CYL_BW);
        public IDOutput OutCstFixCylFw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.OUT_CST_FIX_CYL_FW);
        ...
        public IDOutput RemoveZoneZCyl1Up => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.REMOVE_ZONE_Z_CYL_1_UP);
        public IDOutput RemoveZoneZCyl1Down => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.REMOVE_ZONE_Z_CYL_1_DOWN);
        public IDOutput RemoveZoneZCyl2Up => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.REMOVE_ZONE_Z_CYL_2_UP);
        public IDOutput RemoveZoneZCyl2Down => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.REMOVE_ZONE_Z_CYL_2_DOWN);
        public IDOutput RemoveZoneCylClamp => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.REMOVE_ZONE_CYL_CLAMP);
        public IDOutput RemoveZoneCylUnclamp => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.REMOVE_ZONE_CYL_UNCLAMP);
        ...
        public IDOutput FixtureAlignCylBw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.FIXTURE_ALIGN_CYL_BW);
        public IDOutput FixtureAlignCylFw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.FIXTURE_ALIGN_CYL_FW);
        ...
        public IDOutput AlignStageLBrushCylDown => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_L_BRUSH_CYL_DOWN);
        public IDOutput AlignStageL1Align => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_L_1_ALIGN);
        public IDOutput AlignStageL1Unalign => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_L_1_UNALIGN);
        public IDOutput AlignStageL2Align => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_L_2_ALIGN);
        public IDOutput AlignStageL2Unalign => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_L_2_UNALIGN);
        public IDOutput AlignStageL3Align => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_L_3_ALIGN);
        public IDOutput AlignStageL3Unalign => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_L_3_UNALIGN);
        ...
        public IDOutput AlignStageRBrushCylDown => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_R_BRUSH_CYL_DOWN);
        public IDOutput AlignStageR1Align => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_R_1_ALIGN);
        public IDOutput AlignStageR1Unalign => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_R_1_UNALIGN);
        public IDOutput AlignStageR2Align => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_R_2_ALIGN);
        public IDOutput AlignStageR2Unalign => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_R_2_UNALIGN);
        public IDOutput AlignStageR3Align => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_R_3_ALIGN);
        public IDOutput AlignStageR3Unalign => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.ALIGN_STAGE_R_3_UNALIGN);
        ...
        public IDOutput Shuttle1RVacOnOff => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.SHUTTLE_1_R_VAC_ON_OFF);
        public IDOutput Shuttle2RVacOnOff => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.SHUTTLE_2_R_VAC_ON_OFF);
        public IDOutput Shuttle1LVacOnOff => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.SHUTTLE_1_L_VAC_ON_OFF);
        public IDOutput Shuttle2LVacOnOff => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.SHUTTLE_2_L_VAC_ON_OFF);
        ...
        public IDOutput UnloadAlignCyl1Down => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.UNLOAD_ALIGN_CYL_1_DOWN);
        public IDOutput UnloadAlignCyl2Up => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.UNLOAD_ALIGN_CYL_2_UP);
        public IDOutput UnloadAlignCyl2Down => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.UNLOAD_ALIGN_CYL_2_DOWN);
        ...
        public IDOutput UnloadRobotCyl1Up => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.UNLOAD_ROBOT_CYL_1_UP);
        public IDOutput UnloadRobotCyl1Down => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.UNLOAD_ROBOT_CYL_1_DOWN);
        public IDOutput UnloadRobotCyl2Up => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.UNLOAD_ROBOT_CYL_2_UP);
        public IDOutput UnloadRobotCyl2Down => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.UNLOAD_ROBOT_CYL_2_DOWN);
        public IDOutput UnloadRobotCyl3Up => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.UNLOAD_ROBOT_CYL_3_UP);
        public IDOutput UnloadRobotCyl3Down => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.UNLOAD_ROBOT_CYL_3_DOWN);
        public IDOutput UnloadRobotCyl4Up => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.UNLOAD_ROBOT_CYL_4_UP);
