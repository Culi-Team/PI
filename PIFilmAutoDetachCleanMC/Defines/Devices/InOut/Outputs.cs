...
namespace PIFilmAutoDetachCleanMC.Defines
{
    public class Outputs
    {
        ...
        public IDOutput DetachFixFixtureCyl1Bw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_1_3_UNCLAMP);
        public IDOutput DetachFixFixtureCyl1Fw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_1_3_CLAMP);
        public IDOutput DetachFixFixtureCyl2Bw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_2_4_UNCLAMP);
        public IDOutput DetachFixFixtureCyl2Fw => _dOutputDevice.Outputs.First(i => i.Id == (int)EOutput.DETACH_CLAMP_CYL_2_4_CLAMP);
