...
namespace PIFilmAutoDetachCleanMC.Defines
{
    public class Inputs : ObservableObject
    {
        ...
        public IDInput InShuttleRAlign1FW => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.IN_SHUTTLE_R_ALIGN_1_FW);
        public IDInput InShuttleRAlign1BW => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.IN_SHUTTLE_R_ALIGN_1_BW);
        public IDInput InShuttleRAlign2FW => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.IN_SHUTTLE_R_ALIGN_2_FW);
        public IDInput InShuttleRAlign2BW => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.IN_SHUTTLE_R_ALIGN_2_BW);
        public IDInput InShuttleLAlign1FW => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.IN_SHUTTLE_L_ALIGN_1_FW);
