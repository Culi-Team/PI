...
namespace PIFilmAutoDetachCleanMC.Defines
{
    public class Inputs : ObservableObject
    {
        ...
        public IDInput OutCstWorkDetect4 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.OUT_CST_WORK_DETECT_4);
        ...
        public IDInput Fan1 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_1);
        public IDInput Fan2 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_2);
        ...
        public IDInput TransferFixture1Clamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_1_CLAMP);
        public IDInput TransferFixture1Unclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_1_UNCLAMP);
        public IDInput TransferFixture2Clamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_2_CLAMP);
        public IDInput TransferFixture2Unclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_2_UNCLAMP);
        public IDInput TransferFixture3Clamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_3_CLAMP);
        public IDInput TransferFixture3Unclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_3_UNCLAMP);
        public IDInput TransferFixture4Clamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_4_CLAMP);
        public IDInput TransferFixture4Unclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_4_UNCLAMP);
        public IDInput TransferFixtureDetect => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_DETECT);
        public IDInput TransferFixtureObstructDetect1 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_OBSTRUCT_DETECT_1);
        public IDInput TransferFixtureObstructDetect2 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_OBSTRUCT_DETECT_2);
        ...
        public IDInput DetachFixFixtureCyl1Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_1_BW);
        public IDInput DetachFixFixtureCyl1Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_1_FW);
        public IDInput DetachFixFixtureCyl2Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_2_BW);
        public IDInput DetachFixFixtureCyl2Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_2_FW);
        public IDInput DetachFixFixtureCyl3Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_3_BW);
        public IDInput DetachFixFixtureCyl3Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_3_FW);
        public IDInput DetachFixFixtureCyl4Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_4_BW);
        public IDInput DetachFixFixtureCyl4Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_4_FW);
        public IDInput RemoveZoneIonStaticComplete => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_ION_STATIC_COMPLETE);
        public IDInput RemoveZoneIonMaintenanceDeteced => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_ION_MAINTENANCE_DETECED);
        public IDInput RemoveZoneIonError => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_ION_ERROR);
        public IDInput RemoveZoneIonSensorMonitor => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_ION_SENSOR_MONITOR);
        ...
        public IDInput RemoveZoneFixCyl1Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_1_FW);
        public IDInput RemoveZoneFixCyl1Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_1_BW);
        public IDInput RemoveZoneFixCyl2Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_2_FW);
        public IDInput RemoveZoneFixCyl2Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_2_BW);
        public IDInput RemoveZoneFixCyl3Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_3_FW);
        public IDInput RemoveZoneFixCyl3Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_3_BW);
        public IDInput RemoveZoneFixCyl4Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_4_FW);
        public IDInput RemoveZoneFixCyl4Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_4_BW);
        ...
        public IDInput FixtureAlignDetect => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FIXTURE_ALIGN_DETECT);
        ...
        public IDInput AlignFixtureIonStaticComplete => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.ALIGN_FIXTURE_ION_STATIC_COMPLETE);
        public IDInput AlignFixtureIonMaintenanceDeteced => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.ALIGN_FIXTURE_ION_MAINTENANCE_DETECED);
        public IDInput AlignFixtureIonError => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.ALIGN_FIXTURE_ION_ERROR);
        public IDInput AlignFixtureIonSensorMonitor => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.ALIGN_FIXTURE_ION_SENSOR_MONITOR);
        public IDInput Fan3 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_3);
        public IDInput Fan4 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_4);
        public IDInput Fan5 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_5);
        public IDInput Fan6 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_6);
        ...
        public IDInput WetCleanRightLeakDetect => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.WET_CLEAN_RIGHT_LEAK_DETECT);
        ...
        public IDInput DoorLock8R => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DOOR_LOCK_8_R);
        public IDInput DoorLock8L => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DOOR_LOCK_8_L);
        ...
        public IDInput WetCleanLeftLeakDetect => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.WET_CLEAN_LEFT_LEAK_DETECT);
        ...
        // ========== EInput ==========
        public IDInput TrRotateRightClamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TR_ROTATE_RIGHT_CLAMP);
        public IDInput TrRotateRightUnclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TR_ROTATE_RIGHT_UNCLAMP);
        ...
        public IDInput TrRotateLeftClamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TR_ROTATE_LEFT_CLAMP);
        public IDInput TrRotateLeftUnclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TR_ROTATE_LEFT_UNCLAMP);
        ...
        public IDInput AfCleanRightLeakDetect => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.AF_CLEAN_RIGHT_LEAK_DETECT);
        ...
        public IDInput AfCleanLeftLeakDetect => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.AF_CLEAN_LEFT_LEAK_DETECT);
        ...
        public IDInput OpRButtonRed => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.OP_R_BUTTON_RED);
        public IDInput OpRButtonGreen => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.OP_R_BUTTON_GREEN);
        public IDInput OpRButtonYellow => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.OP_R_BUTTON_YELLOW);
        public IDInput OpREmo => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.OP_R_EMO);
        public IDInput OpLButtonRed => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.OP_L_BUTTON_RED);
        public IDInput OpLButtonGreen => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.OP_L_BUTTON_GREEN);
        public IDInput OpLButtonYellow => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.OP_L_BUTTON_YELLOW);
        ...
        public IDInput Fan7 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_7);
        public IDInput Fan8 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_8);
        public IDInput Fan9 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_9);
        public IDInput Fan10 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_10);
        public IDInput Fan11 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_11);
        public IDInput Fan12 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_12);
        public IDInput Fan13 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_13);
        public IDInput Fan14 => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.FAN_14);
    }
}
