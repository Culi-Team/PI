...
namespace PIFilmAutoDetachCleanMC.Defines
{
    public class Inputs : ObservableObject
    {
        ...
        public IDInput DetachFixFixtureCyl11Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_CYL_1_UNCLAMP);
        public IDInput DetachFixFixtureCyl11Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_CYL_1_CLAMP);
        public IDInput DetachFixFixtureCyl12Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_CYL_2_UNCLAMP);
        public IDInput DetachFixFixtureCyl12Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_CYL_2_CLAMP);
        public IDInput DetachFixFixtureCyl21Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_CYL_3_UNCLAMP);
        public IDInput DetachFixFixtureCyl21Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_CYL_3_CLAMP);
        public IDInput DetachFixFixtureCyl22Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_CYL_4_UNCLAMP);
        public IDInput DetachFixFixtureCyl22Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_CYL_4_CLAMP);
        ...
        public IDInput RemoveZoneCyl1Clamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FILM_1_CLAMP);
        public IDInput RemoveZoneCyl1Unclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FILM_1_UNCLAMP);
        public IDInput RemoveZoneCyl2Clamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FILM_2_CLAMP);
        public IDInput RemoveZoneCyl2Unclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FILM_2_UNCLAMP);
        public IDInput RemoveZoneCyl3Clamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FILM_3_CLAMP);
        public IDInput RemoveZoneCyl3Unclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FILM_3_UNCLAMP);
        ...
        public IDInput RemoveZoneFixCyl11Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_CLAMP_CYL_1_CLAMP);
        public IDInput RemoveZoneFixCyl11Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_CLAMP_CYL_1_UNCLAMP);
        public IDInput RemoveZoneFixCyl12Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_CLAMP_CYL_2_CLAMP);
        public IDInput RemoveZoneFixCyl12Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_CLAMP_CYL_2_UNCLAMP);
        public IDInput RemoveZoneFixCyl21Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_CLAMP_CYL_3_CLAMP);
        public IDInput RemoveZoneFixCyl21Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_CLAMP_CYL_3_UNCLAMP);
        public IDInput RemoveZoneFixCyl22Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_CLAMP_CYL_4_CLAMP);
        public IDInput RemoveZoneFixCyl22Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_CLAMP_CYL_4_UNCLAMP);
