...
namespace PIFilmAutoDetachCleanMC.Defines
{
    public class Inputs : ObservableObject
    {
        ...
        public IDInput AlignFixture1FW => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.ALIGN_FIXTURE_1_FW);
        ...
        public IDInput TransferFixture1_1Clamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_1_1_CLAMP);
        public IDInput TransferFixture1_1Unclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_1_1_UNCLAMP);
        public IDInput TransferFixture1_2Clamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_1_2_CLAMP);
        public IDInput TransferFixture1_2Unclamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_1_2_UNCLAMP);
        public IDInput TransferFixture2_1Clamp => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.TRANSFER_FIXTURE_2_1_CLAMP);
        ...
        public IDInput DetachFixFixtureCyl1_1Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_1_1_BW);
        public IDInput DetachFixFixtureCyl1_1Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_1_1_FW);
        public IDInput DetachFixFixtureCyl1_2Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_1_2_BW);
        public IDInput DetachFixFixtureCyl1_2Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_1_2_FW);
        public IDInput DetachFixFixtureCyl2_1Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_2_1_BW);
        public IDInput DetachFixFixtureCyl2_1Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_2_1_FW);
        public IDInput DetachFixFixtureCyl2_2Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_2_2_BW);
        public IDInput DetachFixFixtureCyl2_2Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.DETACH_FIX_FIXTURE_CYL_2_2_FW);
        ...
        public IDInput RemoveZoneFixCyl1_1Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_1_1_FW);
        public IDInput RemoveZoneFixCyl1_1Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_1_1_BW);
        public IDInput RemoveZoneFixCyl1_2Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_1_2_FW);
        public IDInput RemoveZoneFixCyl1_2Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_1_2_BW);
        public IDInput RemoveZoneFixCyl2_1Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_2_1_FW);
        public IDInput RemoveZoneFixCyl2_1Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_2_1_BW);
        public IDInput RemoveZoneFixCyl2_2Fw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_2_2_FW);
        public IDInput RemoveZoneFixCyl2_2Bw => _dInputDevice.Inputs.First(i => i.Id == (int)EInput.REMOVE_ZONE_FIX_CYL_2_2_BW);
