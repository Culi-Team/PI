...
{
    public class VinylCleanProcTest
    {
        ...
        [Fact]
        public async Task VinylCleanProc_SeqOrigin_Test()
        {
            // Arrange
        ...
        [Fact]
        public async Task VinylCleanProc_SeqVinylClean_Test()
        {
            // Arrange
            TestAppCommon.AppHost = TestAppCommon.BuildHost();
            await TestAppCommon.AppHost!.StartAsync();
        ...
        [Fact]
        public async Task VinylCleanProc_SeqRobotPickFixtureFromVinylClean_Test()
        {
            // Arrange
            TestAppCommon.AppHost = TestAppCommon.BuildHost();
            await TestAppCommon.AppHost!.StartAsync();
            ...
            process.Start();
            process.ProcessMode = EProcessMode.Run;
            process.Sequence = ESequence.RobotPickFixtureFromVinylClean;
