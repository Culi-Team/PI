...
{
    public class GlassTransferProcTest
    {
        ...
        [Fact]
        public async Task GlassTransferProc_SeqOrigin_Test()
        {
            // Arrange
            ...
            var process = TestAppCommon.AppHost.Services.GetKeyedService<IProcess<ESequence>>(EProcess.GlassTransfer.ToString());
        ...
        [Fact]
        public async Task GlassTransferProc_SeqGlassTransferPick_Test()
        {
            // Arrange
            TestAppCommon.AppHost = TestAppCommon.BuildHost();
            await TestAppCommon.AppHost!.StartAsync();
        ...
        [Fact]
        public async Task GlassTransferProc_SeqGlassTransferPlace_Test()
        {
            // Arrange
            TestAppCommon.AppHost = TestAppCommon.BuildHost();
            await TestAppCommon.AppHost!.StartAsync();
