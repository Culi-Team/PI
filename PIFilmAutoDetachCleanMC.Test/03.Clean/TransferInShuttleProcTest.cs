...
{
    public class TransferInShuttleProcTest
    {
        ...
        public async Task TransferInShuttleLeftProc_SeqOrigin_Test(EProcess processKey)
        {
            ...
            var port = processKey == EProcess.TransferInShuttleRight
                ? EPort.Right
                : EPort.Left;
            var process = TestAppCommon.AppHost.Services.GetKeyedService<IProcess<ESequence>>(EProcess.TransferInShuttleLeft.ToString());
        ...
        public async Task TransferInShuttleRightProc_SeqOrigin_Test(EProcess processKey)
        {
            ...
            var port = processKey == EProcess.TransferInShuttleRight
                ? EPort.Right
                : EPort.Left;
            var process = TestAppCommon.AppHost.Services.GetKeyedService<IProcess<ESequence>>(EProcess.TransferInShuttleRight.ToString());
